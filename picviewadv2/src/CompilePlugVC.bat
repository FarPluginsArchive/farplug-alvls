...
@set fileversion=2,0,0,7
@set fileversion_str=2.0 build 7
@set MyDir=%CD%
...
@cl /Zp1 /QIfist /O1i /GF /Gr /GR- /GX- /LD %PlugName%.cpp /D "UNICODE" /D "_UNICODE" /link /subsystem:console /machine:I386 /opt:nowin98 /noentry /nodefaultlib /def:%PlugName%.def kernel32.lib advapi32.lib user32.lib MSVCRT60.LIB libgfl.lib gdi32.lib %PlugName%.res /map:"..\%PlugName%.map" /out:"..\%PlugName%.dll" /merge:.rdata=.text
