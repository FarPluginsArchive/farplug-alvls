...
@cl /Zp8 /QIfist /O1i /GF /Gr /GS- /GR- /EHs-c- /LD %PlugName%.cpp /D "UNICODE" /D "_UNICODE" /link /subsystem:console /machine:I386 /noentry /nodefaultlib /def:%PlugName%.def kernel32.lib advapi32.lib user32.lib MSVCRT60.LIB libgfl.lib gdi32.lib %PlugName%.res /map:"..\%PlugName%.map" /out:"..\%PlugName%.dll" /merge:.rdata=.text
